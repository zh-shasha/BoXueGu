...
//from为security时是从设置密保界面跳转过来的，否则就是从登陆界面跳转过来
    private String from;
    ...
    private void init() {
        ...
        btn_validate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("security".equals(validateName)){
                    if (TextUtils.isEmpty(from)){
                        //设置密保
                    Toast.makeText(FindPswActivity.this,"请输入要验证的密码",Toast.LENGTH_SHORT).show();
                    return;
                }else {
                ...
                if (TextUtils.isEmpty(userName)){
                    ...
                    Toast.makeText(FindPswActivity.this,"请输入的用户名不存在",Toast.LENGTH_SHORT).show();
                    return;
